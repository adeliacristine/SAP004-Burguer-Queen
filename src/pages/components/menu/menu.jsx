...
import AccHeader from './components.jsx/CardHeader';
import CardBody from './components.jsx/CardBody';
import Collapse from './components.jsx/AccCollpse';
  ...
  return (
    <>
        ...
        <Card>
          ...
          <Collapse eventKey="0">
            <CardBody>
              ...
              <BtnP type='button' className='btn btn-lg btn-warning btnFood'
                onClick={(e) => customerRequest(e, 'Suco de fruta natural', 7)}>
                Adicionar{' '}
              </BtnP>
            </CardBody>
          </Collapse>
      ...
      <Accordion>
        <Card>
          ...
          <Collapse eventKey='1'>
            <CardBody>
              {' '}
              Refrigerante 750ml R$10,00
              <BtnP type='button' className='btn btn-lg btn-warning btnFood'
                onClick={(e) => customerRequest(e, 'Refrigerante 750ml', 10)}>
                {' '}
                Adicionar{' '}
              </BtnP>
            </CardBody>
          ...
          <Collapse eventKey='1'>
            <CardBody>
              ...
              Ovo R$1,00
              <BtnP type='button' className='btn btn-lg btn-warning btnFood'
                onClick={(e) => customerRequest(e, 'Ovo', 1)}>
                {' '}
                Adicionar{' '}
              </BtnP>
            </CardBody>
          ...
          <Collapse eventKey='1'>
            <CardBody>
              ...
              <BtnP
                ...
                onClick={(e) => customerRequest(e, 'Queijo', 1)}>
                {' '}
                Adicionar{' '}
              </BtnP>
            </CardBody>
      ...
      <Modal show={show}>
        ...
        <Modal.Body>
          <Form>
            <Form.Check type='switch' id='chicken' label='Frango'
              onChange={() => setChecked('Frango')}
            />
            <Form.Check type='switch' id='meat' label='Bovina'
              onChange={() => setChecked('Bovina')}
            />
            <Form.Check type='switch' id='Vegetarian' label='Vegetariano'
              onChange={() => setChecked('Vegetariano')}
            />
          </Form>
        </Modal.Body>
        <Modal.Footer>
