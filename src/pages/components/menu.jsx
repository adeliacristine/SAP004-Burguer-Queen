  ...
  return (
    <div>
      <div className='d-flex justify-content-center '>
        <BtnP class='warning btnMenu btn btn-lg' click={onClick} title='Breackfast'></BtnP>
        <BtnP type='submit' class='btnMenu btn btn-lg' click={onClick} title='All Day'></BtnP>
      </div>
      ...
      {open && (
        ...
        <div className='d-flex bg-ligth justify-content-start '>
          <div>
            <h2 className='text-light d-flex text-align-center'>Hambúgueres</h2>
            ...
            <h2 className='text-light d-flex text-align-center'>Acompanhamentos</h2>
            <div classname='d-flex flex-row'>
            ...
            <h2 className='text-light d-flex text-align-center'>Bebidas</h2>
